...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlanningStatusEvent'
        db.create_table('planning_planningstatusevent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('planning', self.gf('django.db.models.fields.related.ForeignKey')(related_name='events', to=orm['planning.Planning'])),
            ('event_type', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('planning', ['PlanningStatusEvent'])

        # Adding field 'Planning.percent'
        db.add_column('planning_planning', 'percent',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'PlanningStatusEvent'
        db.delete_table('planning_planningstatusevent')

        # Deleting field 'Planning.percent'
        db.delete_column('planning_planning', 'percent')
    ...
    models = {
        ...
        'planning.planningstatusevent': {
            ...
            'planning': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': "orm['planning.Planning']"})
        },
