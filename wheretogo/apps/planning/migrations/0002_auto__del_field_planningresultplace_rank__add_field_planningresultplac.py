...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PlanningResultPlace.rank'
        db.delete_column('planning_planningresultplace', 'rank')

        # Adding field 'PlanningResultPlace.category_rank'
        db.add_column('planning_planningresultplace', 'category_rank',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'PlanningResultPlace.likes_count'
        db.add_column('planning_planningresultplace', 'likes_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'PlanningResultPlace', fields ['planning', 'place']
        db.create_unique('planning_planningresultplace', ['planning_id', 'place_id'])

        # Adding field 'Place.likes_count'
        db.add_column('planning_place', 'likes_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Removing unique constraint on 'PlanningResultPlace', fields ['planning', 'place']
        db.delete_unique('planning_planningresultplace', ['planning_id', 'place_id'])

        # Adding field 'PlanningResultPlace.rank'
        db.add_column('planning_planningresultplace', 'rank',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Deleting field 'PlanningResultPlace.category_rank'
        db.delete_column('planning_planningresultplace', 'category_rank')

        # Deleting field 'PlanningResultPlace.likes_count'
        db.delete_column('planning_planningresultplace', 'likes_count')

        # Deleting field 'Place.likes_count'
        db.delete_column('planning_place', 'likes_count')
