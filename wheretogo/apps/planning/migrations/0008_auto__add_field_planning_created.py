...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Planning.created'
        db.add_column('planning_planning', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 4, 22, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Planning.created'
        db.delete_column('planning_planning', 'created')
