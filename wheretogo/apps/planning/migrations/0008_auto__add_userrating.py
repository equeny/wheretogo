...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('planning_userrating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rating', to=orm['auth.User'])),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rating', to=orm['planning.Place'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rating', to=orm['planning.Planning'])),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('planning', ['UserRating'])

    def backwards(self, orm):
        # Deleting model 'UserRating'
        db.delete_table('planning_userrating')
    ...
    models = {
        ...
        'planning.planningresultplace': {
            ...
            'planning': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'results'", 'to': "orm['planning.Planning']"}),
            'rank': ('django.db.models.fields.FloatField', [], {'default': '0'})
        },
        'planning.planningstatusevent': {
            'Meta': {'object_name': 'PlanningStatusEvent'},
            'event_type': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {}),
            'planning': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'status_events'", 'to': "orm['planning.Planning']"})
        },
        'planning.userrating': {
            'Meta': {'object_name': 'UserRating'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {}),
            'place': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rating'", 'to': "orm['planning.Place']"}),
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rating'", 'to': "orm['planning.Planning']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rating'", 'to': "orm['auth.User']"})
        },
