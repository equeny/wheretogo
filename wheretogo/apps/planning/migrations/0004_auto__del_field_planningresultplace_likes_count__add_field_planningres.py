...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlanningResultPlace.likes_rank'
        db.add_column('planning_planningresultplace', 'likes_rank',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlanningResultPlace.likes_rank'
        db.delete_column('planning_planningresultplace', 'likes_rank')
    ...
    models = {
        ...
        'profiles.facebookprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_changes': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
