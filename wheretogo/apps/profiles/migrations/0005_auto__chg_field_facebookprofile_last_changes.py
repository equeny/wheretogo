...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookProfile.last_changes'
        db.alter_column('profiles_facebookprofile', 'last_changes', self.gf('django.db.models.fields.DateTimeField')(null=True))
    def backwards(self, orm):

        # Changing field 'FacebookProfile.last_changes'
        db.alter_column('profiles_facebookprofile', 'last_changes', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
    models = {
        'auth.group': {
