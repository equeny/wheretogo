...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookProfile.oauth_token'
        db.add_column('profiles_facebookprofile', 'oauth_token',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FacebookProfile.oauth_token'
        db.delete_column('profiles_facebookprofile', 'oauth_token')
