...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FacebookProfile', fields ['fid']
        db.create_unique('profiles_facebookprofile', ['fid'])

    def backwards(self, orm):
        # Removing unique constraint on 'FacebookProfile', fields ['fid']
        db.delete_unique('profiles_facebookprofile', ['fid'])
